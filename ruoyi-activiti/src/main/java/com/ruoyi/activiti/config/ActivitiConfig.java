...
import com.ruoyi.activiti.listener.BusinessKeyInjectionActivitiEventListener;
    ...
    public ProcessEngineConfigurationConfigurer processEngineConfigurationConfigurer()
    {
        ProcessEngineConfigurationConfigurer configurer = new ProcessEngineConfigurationConfigurer()
        {
            ...
            public void configure(SpringProcessEngineConfiguration processEngineConfiguration)
            {
                ...
                // 创建子流程时，businesskey 不传递问题
                eventListeners.add(new BusinessKeyInjectionActivitiEventListener());
