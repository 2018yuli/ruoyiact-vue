...
//        workflowLeave.setCreateTime(DateUtils.getNowDate());
        workflowLeaveMapper.insertWorkflowLeave(workflowLeave);
        // 开启工作流程
        BizBusiness business = new BizBusiness();
        bizBusinessService.insertBizBusiness(business);
        Map<String, Object> variables = new HashMap<String, Object>();
        // 这里可以设置各个流程变量，key跟模型的代理变量一致
        variables.put("CreateName", workflowLeave.getCreateName());
        variables.put("CreateTime", workflowLeave.getCreateTime() + "");
